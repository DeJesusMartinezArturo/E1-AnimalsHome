...
<!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Tablas (prueba) apartado usuarios -->
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="tables_usuarios.php">Usuario</a>
                        <a class="collapse-item" href="tables_citas.php">Citas</a>
                        <a class="collapse-item" href="tables_servicios.php">Servicios</a>
                    </div>
                </div>
            </li>
